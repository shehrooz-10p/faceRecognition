    ...
    def GetLabelDetectionResults(self):
        ...
        while finished == False:
            ...
            for labelDetection in response['Labels']:
                ...
                if label['Name'] == 'Adult' or label['Name'] == 'Face':
                    ...
                    if 'Parents' in label.keys():
                        print("Parents:")
                        for parent in label['Parents']:
                            print("   " + parent['Name'])

                    if 'Aliases' in label.keys():
                        print("Aliases:")
                        for alias in label['Aliases']:
                            print("   " + alias['Name'])
                    if 'Categories' in label.keys():
                        print("Categories:")
...
def main():
    roleArn = 'arn:aws:iam::051744709538:role/RekognitionRoleToAccessSNS'
    bucket = 'face-recognition-in-videos'
    video = 'video3.mp4'
